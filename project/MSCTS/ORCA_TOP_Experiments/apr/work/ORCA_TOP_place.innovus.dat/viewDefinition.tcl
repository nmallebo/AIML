...
create_library_set -name best_libs\
   -timing\
    [list ${::IMEX::libVar}/mmmc/saed32rvt_ff0p95vn40c.lib\
    ...
    ${::IMEX::libVar}/mmmc/saed32hvt_ff0p95vn40c.lib\
...
create_library_set -name worst_libs_vddh\
   -timing\
    [list ${::IMEX::libVar}/mmmc/saed32hvt_ss0p95vn40c.lib\
...
create_library_set -name worst_libs\
   -timing\
    [list ${::IMEX::libVar}/mmmc/saed32rvt_ss0p75vn40c.lib\
    ...
    ${::IMEX::libVar}/mmmc/saed32lvt_ss0p95vn40c.lib\
    ${::IMEX::libVar}/mmmc/saed32lvt_ulvl_ss0p95vn40c_i0p75v.lib\
    ${::IMEX::libVar}/mmmc/saed32hvt_ss0p75vn40c.lib\
...
create_delay_corner -name worst_corner\
   ...
   -rc_corner cmax
update_delay_corner -name worst_corner -power_domain PD_RISC_CORE\
   -library_set worst_libs_vddh
...
create_analysis_view -name func_worst_scenario -constraint_mode func_worst_mode -delay_corner worst_corner -latency_file ${::IMEX::dataVar}/mmmc/views/func_worst_scenario/latency.sdc
create_analysis_view -name test_best_scenario -constraint_mode test_best_mode -delay_corner best_corner -latency_file ${::IMEX::dataVar}/mmmc/views/test_best_scenario/latency.sdc
create_analysis_view -name func_best_scenario -constraint_mode func_best_mode -delay_corner best_corner -latency_file ${::IMEX::dataVar}/mmmc/views/func_best_scenario/latency.sdc
create_analysis_view -name test_worst_scenario -constraint_mode test_worst_mode -delay_corner worst_corner -latency_file ${::IMEX::dataVar}/mmmc/views/test_worst_scenario/latency.sdc
