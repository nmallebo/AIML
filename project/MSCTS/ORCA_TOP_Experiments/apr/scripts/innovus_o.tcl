...
createInstGroup occ_int1
addInstToInstGroup occ_int1 [dbGet top.insts.name *occ_int*]
createRegion occ_int1  9.728 357.263 82.563 425.075

#createInstGroup occ_int2
#addInstToInstGroup occ_int2 [dbGet top.insts.name *occ_int2*]
#createRegion occ_int2  10.565 254.707 71.261 338.945
...
create_ccopt_flexible_htree -name flex_HTREE -trunk_cell INVX16_LVT -final_cell INVX8_LVT -no_symmetry_buffers -sink_instance_prefix HJ -pin sdram_clk -sink_grid {4 4}
#Synthesizing H tree
