...
create_ccopt_flexible_htree -name flex_HTREE -trunk_cell INVX16_LVT -final_cell INVX8_LVT -no_symmetry_buffers -sink_instance_prefix HJ -pin {clk} -sink_grid {4 4} -sink_grid_box {82 146 697 397} 
