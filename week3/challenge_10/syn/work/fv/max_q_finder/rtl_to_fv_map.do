...
# Generated on: Sat Apr 26 11:11:59 PDT 2025 (Sat Apr 26 18:11:59 UTC 2025)
...
set logfile fv/max_q_finder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/max_q_finder -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/max_q_finder.sv
elaborate_design -golden -root {max_q_finder} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/max_q_finder/fv_map.v.gz
elaborate_design -revised -root {max_q_finder}
...
set_analyze_option -mapping_file fv/max_q_finder/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.max_q_finder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.max_q_finder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.max_q_finder.rtl.fv_map.rpt
