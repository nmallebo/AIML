...
# Generated on: Wed Apr 30 15:26:10 PDT 2025 (Wed Apr 30 22:26:10 UTC 2025)
...
set logfile fv/SequentialMultiplier/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/SequentialMultiplier -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/SequentialMultiplier.sv
elaborate_design -golden -root {SequentialMultiplier} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/SequentialMultiplier/fv_map.v.gz
elaborate_design -revised -root {SequentialMultiplier}
...
set_analyze_option -mapping_file fv/SequentialMultiplier/fv_map.map.do
...
write_compared_points noneq.compared_points.SequentialMultiplier.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.SequentialMultiplier.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.SequentialMultiplier.rtl.fv_map.rpt
